...
<body>
  ...
  <div class="container mx-auto px-4 py-8">
    <header class="text-center mb-12">
      <h1 class="text-4xl font-bold text-gray-800 mb-4">نظام إدارة الدورة</h1>
    ...
    <div class="card bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div class="p-6">
        ...
        <p class="text-gray-600 text-center mb-6">سجل ملاحظاتك وأفكارك لكل درس في الدورة</p>
      ...
      <div class="p-6">
        ...
        <h2 class="text-2xl font-bold text-center mb-4">جدولة الدورة</h2>
        <p class="text-gray-600 text-center mb-6">نظم مواعيد دروسك وتتبع تقدمك في الدورة</p>
